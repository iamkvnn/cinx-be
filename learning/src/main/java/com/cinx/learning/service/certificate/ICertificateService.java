...
public interface ICertificateService {
    ...
    Page<CertificateRequestResponse> getRequestsByCourse(String currentUserId, String courseId, CertificateStatus status, int page, int size, String query, String sort);
    Page<CertificateRequestResponse> getAllRequests(String currentUserId, CertificateStatus status, int page, int size, String query, String sort);
